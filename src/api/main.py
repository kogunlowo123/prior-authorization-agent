"""Prior Authorization Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Prior authorization agent that automates insurance pre-authorization requests, checks coverage eligibility, submits clinical documentation, tracks authorization status, and manages appeals for denials.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
